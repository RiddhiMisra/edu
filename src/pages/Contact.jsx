                ...
                <div className='lg:w-[40%]'>
                    <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                        <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                            ...
                            <p className='font-medium'>Our team is here to help.</p>
                            <p className='font-semibold'>info@eduquest.com</p>
                        </div>
                        <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                            <div className='flex flex-row items-center gap-3'>
                            ...
                            <p className='font-medium'>You are welcome to meet us at our office .</p>
                            <p className='font-semibold'>Voltas House Building, 1st floor, Bistupur, Jamshedpur-831001</p>
                        </div>
                        <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                            <div className='flex flex-row items-center gap-3'>
