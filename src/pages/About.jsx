    ...
    <div className='w-full mx-auto text-white'>
      ...
      <section className='bg-richblack-700'>
        <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
            ...
            Leading the Future of Online Education with Cutting-Edge Innovation for Success.
                <HighLightText text={"Brighter Future"}/>
                <p className='mx-auto mt-3 text-center text-base font-medium text-richblack-300 lg:w-[95%]'>Eduquest is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.</p>
            </header>
      ...
      <section>
        <div className=' mb-16 mt-3 w-screen'>
          {/* <h2 className='text-4xl text-center font-semibold mt-10'>Reviews from other learners</h2>
           { <ReviewSlider />} */}
           <div className='w-full px-4 mb-16 mt-3 flex flex-col items-center'>
