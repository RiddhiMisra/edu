...
// // Images
// import Logo from "../../assets/Logo/Logo-Full-Lightt.png";
...
//           <div className="text-center">Made with ❤ by Riddhi Misra | © 2024 Eduquest</div>
//         </div>
//       </div>
//     </div>
//   );
          ...
          <div className="flex align-items-center">
            <div className="text-center flex flex-col sm:flex-row ">
              <div className="flex ">
                ...
                <Link to='https://github.com/RiddhiMisra' target="__blank" className="text-white hover:underline mr-1">
                   Riddhi Misra
                </Link>
              </div>
              <span> © 2024 Eduquest</span>
            </div>
          </div>
        </div>
      </div>
