            ...
            <form onSubmit={handleSubmit(contactFormSubmit)} className={"flex flex-col gap-7"}>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className='flex flex-row gap-5'>
                        ...
                        <div className='flex w-[calc(100%-90px)] flex-col gap-2'>
                            ...
                            />
                            {
                                errors.phoneNumber && <span className=" text-pink-300">{errors.phoneNumber.message}</span>
                            }
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    ...
                    >
                        ...
                        {
                            errors.message && (
                                <span className=" text-pink-200">Please enter message<sup className='text-pink-300'>*</sup></span>
                            )
                        }
                </div>
