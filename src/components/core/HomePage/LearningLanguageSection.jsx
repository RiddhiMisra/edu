    ...
    <div className='w-11/12 mt-[100px] max-w-maxContent mx-auto'>
      <div className='flex flex-col gap-5 items-center'>
        ...
        <div className='text-center text-richblack-700 mx-auto text-base mt-3 w-[70%]'>
          Using cutting-edge technologies, we make learning things easy.With over 20+ languages, featuring realistic voice-over, progress tracking, custom schedule and much more.
        </div>
